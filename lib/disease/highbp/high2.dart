...
import 'package:ragaviz/disease/highbp/raga_selector_highbp.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:charts_flutter/flutter.dart' as charts;

class HighBP2 extends StatefulWidget {
  _HighBP2 createState() => _HighBP2();
}

class _HighBP2 extends State<HighBP2> {
  var records = [];
                  ...
                  RaisedButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => RagaSelectorHighBP()));
                    },
                    color: Color(0xFF004761),
                    textColor: Colors.white,
                    child: Text(
