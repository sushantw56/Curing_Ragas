...
class StressPlayer extends StatefulWidget {
  @override
  _StressPlayerState createState() => _StressPlayerState();
}

class _StressPlayerState extends State<StressPlayer> {
  ...
  Widget remoteUrl() {
    return SingleChildScrollView(
      child: _Tab(children: [
        ...
        Text(
          'Best Time to listen : 2pm to 4pm.                                  ',
          style: TextStyle(fontSize: 20, fontFamily: 'Source Sans Pro'),
        ),
        Text(
